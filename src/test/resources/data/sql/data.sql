DELETE FROM members_coupons_mapping;
DELETE FROM member;
DELETE FROM coupon;

INSERT INTO member(id, member_id, last_name, first_name)
...
INSERT INTO coupon(id, coupon_id, valid_from, valid_until, latitude, longitude, city)
...
INSERT INTO members_coupons_mapping(member_id, coupon_id)
VALUES (1000, 10000),
       (1000, 10001),
       (1000, 10002),
       (1000, 10006);