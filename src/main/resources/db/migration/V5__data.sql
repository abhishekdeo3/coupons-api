INSERT INTO test.member(id, member_id, last_name, first_name)
...
INSERT INTO test.coupon(id, coupon_id, valid_from, valid_until, latitude, longitude, city)
...
INSERT INTO test.members_coupons_mapping(member_id, coupon_id)
VALUES (1000, 10000),
       (1000, 10001),
       (1000, 10002),
       (1000, 10006);